...
<form onSubmit={handleSubmit} className="w-[700px] max-sm:w-[320px] bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
    <div className="mb-4">
        ...
        <div className="mb-6">
            ...
            <input onChange={(e) => setNewEmail(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="email" placeholder="Email" />
        </div>
