...
<div className="max-w-6xl mx-auto bg-white my-6">
  
            <div className="text-center px-6">
                <h2 className="text-3xl font-extrabold">Contactez-nous</h2>
                <p className="text-sm text-gray-400 mt-3">Posez-nous les questions ?</p>
            </div>
            <div className="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
                <div className="bg-[#011c2b] rounded-lg p-6 max-lg:text-center">
                    <h2 className="text-xl font-bold text-white">Information de contact</h2>
                    ...
                    <ul className="mt-16 space-y-10">
                        <li className="flex items-center max-lg:justify-center">
                            ...
                            <a href="/" className="text-white text-sm ml-3">
                                <strong className="text-white">aryas_home@gmail.com</strong>
                            </a>
                        </li>
                        <li className="flex items-center max-lg:justify-center">
                            ...
                            <a href="/" className="text-white text-sm ml-3">
                                <strong className="text-white">+33767378435</strong>
                            </a>
                        </li>
                        <li className="flex items-center max-lg:justify-center">
                            ...
                            <a href="/" className="text-white text-sm ml-3">
                                <strong className="text-white">23 boulevard de la muette Garges les gonesse 95140</strong>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div className="grid sm:grid-cols-2 gap-8">
                            ...
                            <div className="relative flex items-center sm:col-span-2">
                                <textarea placeholder="Write Message"
                                    className="px-2 pt-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#011c2b] outline-none h-[100px]"></textarea>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2"
                                    viewBox="0 0 682.667 682.667">
                                    <defs>
                                        <clipPath id="a" clipPathUnits="userSpaceOnUse">
